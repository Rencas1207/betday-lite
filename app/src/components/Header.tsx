...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 flex h-20 w-full items-center justify-center border-b border-slate-200 bg-slate-950 px-6 shadow-md transition-all">
      <div className="flex w-full max-w-360 items-center justify-between">
        <div className="flex items-center gap-2">
          <Link href="/" className="group flex items-center gap-2">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-emerald-500 transition-transform group-hover:scale-105">
        ...
        <div className="flex items-center gap-6">
          ...
          {session && (
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-3 border-l border-slate-800 pl-6 text-white">
